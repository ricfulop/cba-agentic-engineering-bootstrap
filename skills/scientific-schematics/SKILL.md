...
Do **not** generate AI figures for journal manuscripts. This skill is for
board slides and early review cartoons. Final figures are real data
renderings via `lib/styles.py`. A graphical abstract, if the venue asks
for one, is a data figure.
